  ...
  _createClass(Model, [{
    ...
    value: function _prepareSchema() {
      ...
      for (var key in this.schema) {
        ...
        if ('default' in prop) {
          this.setIfEmpty(_defineProperty({}, key, prop.default));
        }
      }
    }
  }, {
    key: 'setIfEmpty',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(prop) {
        var values, keys, count, i, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 12:
                ...
                return _context.abrupt('return', this.set(values));
    ...
    key: 'clear',
    value: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(emitter) {
        var exec;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 9:
                ...
                return _context10.abrupt('return', dataStorage[item] || null);
