...
var Model = function () {
  ...
  _createClass(Model, [{
    ...
    */
    ...
    /**
      * syncMany
      * @description sincroniza um alista de objectos retonando em um callback único
    */
    ...
    value: function getStorageProps() {
      ...
      return new Promise(function (resolve, reject) {
        that.storage.getItem(that.key, function () {
          var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(err, value) {
              ...
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    ...
                    return _context8.abrupt('return', reject(err));
