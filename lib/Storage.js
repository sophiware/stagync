...
function () {
  ...
  _createClass(Storage, [{
    ...
    key: "createInstance",
    value: function () {
      var _createInstance = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                storage = new Storage();
                _context2.next = 3;
                return storage._setup(this.config);
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                _context3.t0 = regeneratorRuntime.keys(this.schema);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee4(key, prop) {
        var data, value;
    ...
    value: function _prepareVirtualProps() {
      ...
      var _loop = function _loop(key) {
        ...
        if (typeof prop.get === 'function') {
          _this._virtualProps[key] = prop;
          var instance = (0, _clone["default"])(_this); // Substitui o this.get para evitar loop infinito
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 14:
                ...
                this.emit(key, _context7.t2 || defaultError);
                return _context7.abrupt("continue", 3);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee8(props) {
        var _this3 = this;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                _context8.t0 = regeneratorRuntime.keys(props);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee10(prop) {
        var exec;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 2:
                ...
                return _context10.abrupt("return", exec);
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 5:
                result = {};
                _context11.t0 = regeneratorRuntime.keys(this.virtualProps);
        ...
        return regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 12:
                return _context12.abrupt("return", dataStorage[item]);
              ...
              case 18:
                vProps = _context12.sent;
                return _context12.abrupt("return", (0, _deepmerge["default"])(data, vProps));
    ...
    value: function discontinueAll() {
      ...
      local.map(function (eventName) {
        ...
        _this4.removeByEventNameStorage(eventName);
      });
      return removed;
    }
  }, {
    ...
    value: function discontinueGlobalAll() {
      ...
      if (eventsNamesStorage.global.length > 0) {
        eventsNamesStorage.global.map(function (eventName) {
          ...
          _this5.removeByEventNameStorage(eventName, true);
        });
      }
